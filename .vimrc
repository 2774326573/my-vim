...
Plugin 'jiangmiao/auto-pairs' "自动补全"
...
"plugin 'vim-airline-themes'  "Airline主题" 
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "# Author: wutong") 
		call append(line(".")+2, "# mail: 2774326573@qq.com") 
